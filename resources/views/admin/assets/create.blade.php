...
@section('content')
    <div class="container border border-success rounded-3 p-3 mb-4">
        ...
        <div class="row">
            <form action="{{ route('assets.store') }}" method="post" enctype="multipart/form-data" id="MyForm">
                @csrf
                @method('POST')
                ...
                <div class="mb-3">
                    <label for="name" class="form-label text-uppercase fw-bold">AMMONTARE</label>
                ...
                <button type="button" class="btn btn-success text-white" onclick="validationForm()" value="Submit form">SALVA</button>
            </form>
        </div>
    </div>
